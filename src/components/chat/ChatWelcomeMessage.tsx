...
const ChatWelcomeMessage: React.FC = () => {
  return (
    <div className="bg-pakistani-green-50 rounded-lg p-6 mb-6 border border-pakistani-green-200 shadow-sm relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-pakistani-green-50 to-pakistani-green-100 opacity-50 z-0"></div>
      <div className="moving-dots"></div>
      <div className="relative z-10 flex items-start">
        <div className="bg-pakistani-green-200 rounded-full p-3 mr-4 shadow-md">
          <MessageSquare className="h-6 w-6 text-pakistani-green-700" />
        </div>
        <div>
          <div className="font-medium text-pakistani-green-800 text-lg mb-2">AI Support</div>
