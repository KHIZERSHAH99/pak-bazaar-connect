-- Add phone number association for existing admin account and improve phone login
BEGIN;
...
-- 4) Create sample phone accounts for testing if they don't exist
INSERT INTO public.profiles (id, email, phone_number, normalized_phone, role, contact_name, business_name)
VALUES 
  ('33333333-3333-3333-3333-333333333333', '03001234569@test-phone.com', '03001234569', '03001234569', 'seller', 'Test Seller', 'Test Seller Business'),
  ('44444444-4444-4444-4444-444444444444', '03211234567@test-phone.com', '03211234567', '03211234567', 'wholesaler', 'Test Wholesaler', 'Test Wholesaler Business')
ON CONFLICT (id) DO NOTHING;

-- 5) Create corresponding auth users for these test accounts
-- Note: These will be created with temporary emails but can be logged into with phone numbers
