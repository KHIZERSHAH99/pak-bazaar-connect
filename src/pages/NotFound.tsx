    ...
    <Layout title="Page Not Found - Pak Bazaar Connect">
      <div className="container mx-auto px-4 py-16 text-center min-h-[60vh] flex flex-col justify-center">
        <div className="max-w-md mx-auto">
          ...
          <h2 className="text-3xl font-semibold text-foreground/80 mb-4 font-poppins">Page Not Found</h2>
          <p className="text-xl text-muted-foreground mb-8 font-poppins">
            The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/">
              <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-poppins w-full sm:w-auto">
