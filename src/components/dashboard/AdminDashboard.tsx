    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
      <Link to="/admin">
        <Card className="p-4 md:p-6 hover:bg-gray-50 transition-colors cursor-pointer h-full hover:shadow-md">
          ...
          <p className="text-gray-600 font-poppins text-sm md:text-base">Comprehensive platform overview and management tools.</p>
        </Card>
      </Link>
      ...
      <Card className="p-4 md:p-6 bg-blue-50 border-blue-200">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-semibold font-poppins text-blue-800">Platform Security</h3>
        </div>
        <p className="text-blue-700 font-poppins text-sm md:text-base">Monitor platform security, user verification, and fraud prevention.</p>
      </Card>
    </div>
  </div>
);
