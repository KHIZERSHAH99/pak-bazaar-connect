    ...
    <section className="relative py-12 md:py-24 lg:py-32 bg-gradient-to-b from-primary/5 to-background overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 md:mb-6 leading-tight font-poppins">
            {language === 'ur' ? (
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-8 md:mb-12 px-2 sm:px-0">
            <Link to={user ? "/dashboard" : "/signup"}>
              <Button 
                size="lg" 
                className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-poppins shadow-lg hover:shadow-xl transition-all duration-200 w-full sm:w-auto"
              >
            ...
            <Link to="/products">
              <Button 
                size="lg" 
                variant="outline" 
                className="border-primary text-primary hover:bg-primary/10 px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-poppins w-full sm:w-auto"
              >
                {t('browseProducts')}
              </Button>
            </Link>
