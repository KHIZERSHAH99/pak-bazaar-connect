    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-green-50 flex flex-col">
      ...
      <div className="container mx-auto flex-grow py-12 px-4">
        <div className="text-center mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-pakistani_green-800">Join Pakistan's Leading B2B Marketplace</h1>
          <p className="text-gray-600 mt-2">Connect with trusted buyers and suppliers across Pakistan</p>
        </div>
