...
-- 2. Create secure view for profiles (drop existing if any)
...
-- 4. Strengthen RLS policies for critical tables
-- ===============================================
...
-- 6. Create security monitoring dashboard view
-- ============================================
...
AND tablename NOT IN ('schema_migrations', 'security_metrics', 'commission_summary_secure', 'orders_with_safe_profiles', 'profiles_public')
AND NOT EXISTS (
...
-- 7. Clean up old sensitive data automatically
-- ============================================
...
-- 8. Add indexes for better performance on security queries
-- ==========================================================
