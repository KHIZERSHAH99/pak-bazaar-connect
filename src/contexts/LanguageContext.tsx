...
const translations = {
  en: {
    ...
    'whyChoose.description': 'Built for how Pakistani wholesale trade actually works — not how Silicon Valley thinks it should',
    'whyChoose.wholesalers.title': 'For Wholesalers',
    'whyChoose.wholesalers.description': 'Get discovered by new retailers without relying on word of mouth alone',
    'whyChoose.wholesalers.benefit1': 'Your own digital shop — visible to all buyers',
    'whyChoose.wholesalers.benefit2': 'Manage orders & stock in one place',
    'whyChoose.wholesalers.benefit3': '100% free to list — zero commission',
    'whyChoose.sellers.title': 'For Retailers',
    'whyChoose.sellers.description': 'Find and compare wholesalers without visiting markets or calling around',
    'whyChoose.sellers.benefit1': 'Compare prices across multiple suppliers',
    'whyChoose.sellers.benefit2': 'See real stock & MOQ before ordering',
    'whyChoose.sellers.benefit3': 'Order anytime — no market hours needed',
    'whyChoose.secure.title': 'Trust Between Strangers',
    'whyChoose.secure.description': 'Do business with new people confidently — verified profiles and payment proof',
    'whyChoose.secure.benefit1': 'CNIC-verified wholesaler profiles',
    'whyChoose.secure.benefit2': 'Payment screenshot proof on every order',
    'whyChoose.secure.benefit3': 'Full order tracking & history',
  ...
  ur: {
    ...
    // Why Choose Us
    'whyChoose.title': 'پاک منڈی کیوں؟',
    'whyChoose.description': 'پاکستان کی تھوک تجارت کے حساب سے بنایا گیا — آپ کے کاروبار کے لیے',
    'whyChoose.wholesalers.title': 'ہول سیلرز کے لیے',
    'whyChoose.wholesalers.description': 'نئے خریداروں تک پہنچیں — صرف جان پہچان پر انحصار نہ کریں',
    'whyChoose.wholesalers.benefit1': 'اپنی ڈیجیٹل دکان — سب خریداروں کو نظر آئے',
    'whyChoose.wholesalers.benefit2': 'آرڈرز اور اسٹاک ایک جگہ سنبھالیں',
    'whyChoose.wholesalers.benefit3': 'مکمل مفت — کوئی کمیشن نہیں',
    'whyChoose.sellers.title': 'دکانداروں کے لیے',
    'whyChoose.sellers.description': 'بازار جائے بغیر ہول سیلرز تلاش کریں اور قیمتیں موازنہ کریں',
    'whyChoose.sellers.benefit1': 'کئی سپلائرز کی قیمتیں ایک جگہ دیکھیں',
    'whyChoose.sellers.benefit2': 'اسٹاک اور کم از کم آرڈر پہلے سے معلوم',
    'whyChoose.sellers.benefit3': 'کسی بھی وقت آرڈر کریں — بازار کے اوقات کی پابندی نہیں',
    'whyChoose.secure.title': 'اجنبیوں کے درمیان اعتماد',
    'whyChoose.secure.description': 'نئے لوگوں سے اطمینان سے کاروبار کریں — تصدیق شدہ پروفائلز اور ادائیگی کا ثبوت',
    'whyChoose.secure.benefit1': 'شناختی کارڈ سے تصدیق شدہ ہول سیلرز',
    'whyChoose.secure.benefit2': 'ہر آرڈر پر ادائیگی کا اسکرین شاٹ',
    'whyChoose.secure.benefit3': 'مکمل آرڈر ٹریکنگ اور ریکارڈ',
