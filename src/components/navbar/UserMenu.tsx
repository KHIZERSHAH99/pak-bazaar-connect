...
import { User, LayoutDashboard, LogOut, ChevronDown, Sun, Moon } from 'lucide-react';
...
const UserMenu: React.FC<UserMenuProps> = ({ email, role, onLogout, getRoleBadge }) => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56 bg-popover border border-border shadow-lg z-[200]">
