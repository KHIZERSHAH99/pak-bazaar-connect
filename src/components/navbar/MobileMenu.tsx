...
const MobileMenu: React.FC<MobileMenuProps> = ({ 
  ...
  return (
    <div className="md:hidden py-4 px-2 space-y-3 border-t border-border animate-slideIn bg-background/95 backdrop-blur-sm shadow-xl z-[110] fixed left-0 right-0 top-16">
      <Link 
        to="/" 
