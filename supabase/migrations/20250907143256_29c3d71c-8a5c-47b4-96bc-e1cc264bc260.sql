-- Enhanced address management for orders
-- Add structured address fields and address book for sellers

-- Create address book table for sellers to save multiple addresses
CREATE TABLE IF NOT EXISTS public.seller_addresses (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID NOT NULL,
  address_type TEXT NOT NULL DEFAULT 'delivery', -- 'delivery', 'billing', 'return'
...
-- Add enhanced shipping and address fields to orders table
...
ADD COLUMN IF NOT EXISTS shipping_method TEXT, -- 'standard', 'express', 'courier'
ADD COLUMN IF NOT EXISTS shipping_cost NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS return_address TEXT,
ADD COLUMN IF NOT EXISTS tracking_url TEXT, -- Full tracking URL
ADD COLUMN IF NOT EXISTS shipped_by TEXT, -- Name of person who shipped
ADD COLUMN IF NOT EXISTS packed_by TEXT, -- Name of person who packed
ADD COLUMN IF NOT EXISTS delivery_partner TEXT; -- Courier company name

-- Create shipping details table for detailed tracking
...
-- Add index for shipping details
...
-- Add provinces lookup table for Pakistan
...
-- Add cities table for major Pakistani cities
...
-- Enable RLS for provinces and cities
ALTER TABLE public.provinces ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.cities ENABLE ROW LEVEL SECURITY;

-- Everyone can view provinces and cities
