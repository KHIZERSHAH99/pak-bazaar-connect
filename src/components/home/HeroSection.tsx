        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-white text-primary hover:bg-gray-100 font-poppins" onClick={() => navigate('/dashboard/seller-dashboard')}>
                Browse Shops & Order
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              
              <Button size="lg" variant="outline" onClick={() => navigate(user ? '/dashboard' : '/signup')} className="border-white hover:bg-white font-poppins font-medium text-green-950">
                {user ? 'Wholesaler Dashboard' : 'Wholesaler Signup'}
              </Button>
            </div>
