...
const UserProfile: React.FC = () => {
  ...
  return <div className="mb-6 flex flex-col items-center p-4 rounded-lg border border-border/50 bg-white/[0.31]">
      ...
      <div className="text-center">
        ...
        <Badge variant={profile.role === 'admin' ? 'default' : profile.role === 'wholesaler' || profile.role === 'seller' ? 'secondary' : 'outline'} className="capitalize font-poppins">
          {profile.role}
        </Badge>
      </div>
    </div>;
