-- Fix authentication email formats and profile synchronization
...
-- Updated function to validate authentication input
...
-- Updated function to authenticate user by phone with all email formats
